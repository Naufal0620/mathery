...
<head>
    ...
    <title>@yield('title', 'Mathery - Admin Dashboard')</title>
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-gray-50 border-r-2 border-gray-300/60 flex flex-col transition-transform duration-300 transform -translate-x-full md:relative md:translate-x-0 md:inset-0 shadow-2xl md:shadow-none">
        ...
        <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
            ...
            <a href="{{ route('admin.dashboard') }}" 
               class="nav-item flex items-center space-x-3 w-full p-3 rounded-xl transition-all duration-300 group {{ request()->routeIs('admin.dashboard') ? 'text-white bg-gradient-to-r from-indigo-700 to-purple-600 shadow-md' : 'text-gray-600 hover:text-white hover:bg-gradient-to-r hover:from-indigo-700 hover:to-purple-600' }}">
            ...
            <a href="{{ route('admin.classes') }}" 
               class="nav-item flex items-center space-x-3 w-full p-3 rounded-xl transition-all duration-300 group {{ request()->routeIs('admin.classes') ? 'text-white bg-gradient-to-r from-indigo-700 to-purple-600 shadow-md' : 'text-gray-600 hover:text-white hover:bg-gradient-to-r hover:from-indigo-700 hover:to-purple-600' }}">
                <i class='bx bx-whiteboard bx-sm'></i>
                <span class="font-medium">Manajemen Kelas</span>
            </a>

            <a href="{{ route('admin.syllabus') }}" 
               class="nav-item flex items-center space-x-3 w-full p-3 rounded-xl transition-all duration-300 group {{ request()->routeIs('admin.syllabus') ? 'text-white bg-gradient-to-r from-indigo-700 to-purple-600 shadow-md' : 'text-gray-600 hover:text-white hover:bg-gradient-to-r hover:from-indigo-700 hover:to-purple-600' }}">
                <i class='bx bx-calendar-event bx-sm'></i>
                <span class="font-medium">Jadwal & Topik</span>
            </a>

            <a href="{{ route('admin.materials.index') }}" 
               class="nav-item flex items-center space-x-3 w-full p-3 rounded-xl transition-all duration-300 group {{ request()->routeIs('admin.materials.index') ? 'text-white bg-gradient-to-r from-indigo-700 to-purple-600 shadow-md' : 'text-gray-600 hover:text-white hover:bg-gradient-to-r hover:from-indigo-700 hover:to-purple-600' }}">
                <i class='bx bx-calendar-event bx-sm'></i>
            ...
            <p class="px-4 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 mt-6">Sistem</p>
            
            <a href="{{ route('admin.activity') }}" 
               class="nav-item flex items-center space-x-3 w-full p-3 rounded-xl transition-all duration-300 group {{ request()->routeIs('admin.activity') ? 'text-white bg-gradient-to-r from-indigo-700 to-purple-600 shadow-md' : 'text-gray-600 hover:text-white hover:bg-gradient-to-r hover:from-indigo-700 hover:to-purple-600' }}">
    ...
    <div class="flex flex-col flex-1 w-full min-w-0">
        ...
        <nav class="h-20 px-4 md:px-8 flex justify-between items-center bg-gray-50 border-b-2 border-gray-300/60 shrink-0 sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-lg md:text-xl font-bold text-gray-700 truncate">@yield('header_title', 'Dashboard Overview')</h2>
            </div>
        ...
        <main class="flex-1 overflow-y-auto p-4 md:p-5 relative">
            @yield('content')
        </main>
    </div>
